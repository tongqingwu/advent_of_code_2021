...
def find_codes(inps, outs):
    ...
    for i in inps:
        ...
        if len_i == 7:
            tmp_6.append(i)
            tmp = i.replace(dict_code['bd'][0], '').replace(dict_code['bd'][1], '').replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(real_code['a'], '')
            if len(tmp) == 2:
                dict_code['eg'] = tmp
    ...
    d4 = ''
    for o in outs:
        d4 += get_num(o, real_code, dict_code)
...
def get_num(o, real_code, dict_code):
    if len(o) == 2:
    ...
    if len(o) == 4:
        t = o.replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(dict_code['bd'][0], '').replace(
            dict_code['bd'][1], '')
        if len(t) == 0:
            return '4'
...
def get_c(real_code, dict_code, tmp5):
    c = ''
    for i in tmp5:
        cc = i.replace(dict_code['a'], '').replace(dict_code['eg'][0], '').replace(dict_code['eg'][1], '').replace(real_code['d'], '')
        if c == '' and len(cc) == 1:
            return cc
...
def get_g_by_d(real_code, dict_code, tmp5):
    g = ''
    for i in tmp5:
        gg = i.replace(dict_code['a'], '').replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(real_code['d'], '')
        if g == '' and len(gg) == 1:
            return gg
...
def get_d_by_g(real_code, dict_code, tmp5):
    d = ''
    for i in tmp5:
        dd = i.replace(real_code['a'], '').replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(real_code['g'], '')
        if d == '' and len(dd) == 1:
            return dd
...
def get_g_by_f(real_code, dict_code, tmp5):
    g = ''
    for i in tmp5:
        gg = i.replace(real_code['a'], '').replace(dict_code['bd'][0], '').replace(dict_code['bd'][1], '').replace(real_code['f'], '')
        if g == '' and len(gg) == 1:
            return gg
...
def get_f_by_g(real_code, dict_code, tmp5):
    f = ''
    for i in tmp5:
        ff = i.replace(real_code['a'], '').replace(dict_code['bd'][0], '').replace(dict_code['bd'][1], '').replace(real_code['g'], '')
        if f == '' and len(ff) == 1:
            return ff
...
def get_bfg(dict_code, tmp6):
    b = f = g = None
    for i in tmp6:
        bb = i.replace(dict_code['eg'][0], '').replace(dict_code['eg'][1], '').replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(dict_code['a'], '')
        ff = i.replace(dict_code['bd'][0], '').replace(dict_code['bd'][1], '').replace(dict_code['eg'][0], '').replace(dict_code['eg'][1], '').replace(dict_code['a'], '')
        gg = i.replace(dict_code['bd'][0], '').replace(dict_code['bd'][1], '').replace(dict_code['cf'][0], '').replace(dict_code['cf'][1], '').replace(dict_code['a'], '')
